...
//==========================================================
// 静的領域
CTexture	*CAreaObjectTutorialJointChar::pRefTexTutorialJointChar = NULL;

//==========================================================
// メソッド定義
CAreaObjectTutorialJointChar::CAreaObjectTutorialJointChar(){
...
void CAreaObjectTutorialJointChar::Init(SVector3D _initPos){
	...
	polyImage.SetReferenceTexture(pRefTexTutorialJointChar);
...
void CAreaObjectTutorialJointChar::Update(){
...
void CAreaObjectTutorialJointChar::Sync(){
	CBaseAreaObject::Sync();
}

void CAreaObjectTutorialJointChar::Render(){
