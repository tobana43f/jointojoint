...
//==========================================================
// 静的領域
CTexture	*CAreaObjectTutorialSeparateObj::pRefTexTutorialSeparateObj = NULL;

//==========================================================
// メソッド定義
CAreaObjectTutorialSeparateObj::CAreaObjectTutorialSeparateObj(){
...
void CAreaObjectTutorialSeparateObj::Init(SVector3D _initPos){
	...
	polyImage.SetReferenceTexture(pRefTexTutorialSeparateObj);
...
void CAreaObjectTutorialSeparateObj::Update(){
...
void CAreaObjectTutorialSeparateObj::Sync(){
	CBaseAreaObject::Sync();
}

void CAreaObjectTutorialSeparateObj::Render(){
