...
//==========================================================
// 静的領域
CTexture	*CAreaObjectTutorialSeparateChar::pRefTexTutorialSeparateChar = NULL;

//==========================================================
// メソッド定義
CAreaObjectTutorialSeparateChar::CAreaObjectTutorialSeparateChar(){
...
void CAreaObjectTutorialSeparateChar::Init(SVector3D _initPos){
	...
	polyImage.SetReferenceTexture(pRefTexTutorialSeparateChar);
...
void CAreaObjectTutorialSeparateChar::Update(){
...
void CAreaObjectTutorialSeparateChar::Sync(){
	CBaseAreaObject::Sync();
}

void CAreaObjectTutorialSeparateChar::Render(){
