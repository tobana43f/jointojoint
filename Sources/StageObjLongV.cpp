...
//---------
// 初期化
void CStageObjLongV::Init(SVector3D _initPos, float _initAngle){
	// 一度解放
	Destroy();
...
//-------------------
// ブロックの初期化
void CStageObjLongV::InitBlockObj(){
	// 各ブロックの変数
	...
	pObj1_->SetSize(BLOCK_SIZE, BLOCK_SIZE * 3);	// サイズ 2*1
