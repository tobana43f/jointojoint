...
//---------
// 初期化
void CStageObjLong::Init(SVector3D _initPos, float _initAngle){
	// 一度解放
	Destroy();
...
//-------------------
// ブロックの初期化
void CStageObjLong::InitBlockObj(){
	// 各ブロックの変数
	...
	pObj1_->SetSize(BLOCK_SIZE * 3, BLOCK_SIZE);	// サイズ 2*1
