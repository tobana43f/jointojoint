...
//-----------------
// コンストラクタ
CStageObjCorner::CStageObjCorner(){
...
//---------
// 初期化
void CStageObjCorner::Init(SVector3D _initPos, float _initAngle){
	// 一度解放
	Destroy();
...
//-------------------
// ブロックの初期化
void CStageObjCorner::InitBlockObj(){
	// 各ブロックの変数
	...
	pObj1_->SetSize(BLOCK_SIZE, BLOCK_SIZE);	// サイズ 2*1
