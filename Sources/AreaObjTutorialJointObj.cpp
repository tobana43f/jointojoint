...
//==========================================================
// 静的領域
CTexture	*CAreaObjectTutorialJointObj::pRefTexTutorialJointObj = NULL;

//==========================================================
// メソッド定義
CAreaObjectTutorialJointObj::CAreaObjectTutorialJointObj(){
...
void CAreaObjectTutorialJointObj::Init(SVector3D _initPos){
	...
	polyImage.SetReferenceTexture(pRefTexTutorialJointObj);
...
void CAreaObjectTutorialJointObj::Update(){
...
void CAreaObjectTutorialJointObj::Sync(){
	CBaseAreaObject::Sync();
}

void CAreaObjectTutorialJointObj::Render(){
