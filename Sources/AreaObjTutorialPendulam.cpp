...
//==========================================================
// 静的領域
CTexture	*CAreaObjectTutorialPendulam::pRefTexTutorialPendulam = NULL;

//==========================================================
// メソッド定義
CAreaObjectTutorialPendulam::CAreaObjectTutorialPendulam(){
...
void CAreaObjectTutorialPendulam::Init(SVector3D _initPos){
	...
	polyImage.SetReferenceTexture(pRefTexTutorialPendulam);
...
void CAreaObjectTutorialPendulam::Update(){
...
void CAreaObjectTutorialPendulam::Sync(){
	CBaseAreaObject::Sync();
}

void CAreaObjectTutorialPendulam::Render(){
