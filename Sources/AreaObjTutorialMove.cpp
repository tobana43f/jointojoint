...
//==========================================================
// 静的領域
CTexture	*CAreaObjectTutorialMove::pRefTexTutorialMove = NULL;

//==========================================================
// メソッド定義
CAreaObjectTutorialMove::CAreaObjectTutorialMove(){
...
void CAreaObjectTutorialMove::Init(SVector3D _initPos){
	...
	polyImage.SetReferenceTexture(pRefTexTutorialMove);
...
void CAreaObjectTutorialMove::Update(){
...
void CAreaObjectTutorialMove::Sync(){
	CBaseAreaObject::Sync();
}

void CAreaObjectTutorialMove::Render(){
