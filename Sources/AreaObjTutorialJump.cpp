...
//==========================================================
// 静的領域
CTexture	*CAreaObjectTutorialJump::pRefTexTutorialJump = NULL;

//==========================================================
// メソッド定義
CAreaObjectTutorialJump::CAreaObjectTutorialJump(){
...
void CAreaObjectTutorialJump::Init(SVector3D _initPos){
	...
	polyImage.SetReferenceTexture(pRefTexTutorialJump);
...
void CAreaObjectTutorialJump::Update(){
...
void CAreaObjectTutorialJump::Sync(){
	CBaseAreaObject::Sync();
}

void CAreaObjectTutorialJump::Render(){
