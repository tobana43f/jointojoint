...
//-----------------
// コンストラクタ
CStageObjSquare::CStageObjSquare(){
...
//---------
// 初期化
void CStageObjSquare::Init(SVector3D _initPos, float _initAngle){
	// 一度解放
	Destroy();
...
//-------------------
// ブロックの初期化
void CStageObjSquare::InitBlockObj(){
	// 各ブロックの変数
	...
	pObj1_->SetSize(BLOCK_SIZE * 2, BLOCK_SIZE * 2);	// サイズ 2*1
